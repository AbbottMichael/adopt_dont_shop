...
save_and_open_page
    a_shelter = find("#shelter-#{@shelter_1.id}")
    r_shelter = find("#shelter-#{@shelter_2.id}")
    f_shelter = find("#shelter-#{@shelter_3.id}")

    expect(r_shelter).to appear_before(f_shelter)
    expect(f_shelter).to appear_before(a_shelter)
